...
LoopSkipStatement::LoopSkipStatement(LoopSkipType type):type(type) { }
...
LoopSkipStatement::~LoopSkipStatement(){}
...
int LoopSkipStatement::accept(ImpVisitor* v) {
  return v->visit(this);
}
...
void LoopSkipStatement::accept(TypeVisitor* v) {
  return v->visit(this);
}
